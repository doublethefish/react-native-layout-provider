...
const defaultMapLayoutToProps = (layout: GetLayoutState): GetLayoutProps =>
  layout;
const mergeProps = (
  contextProps: GetLayoutProps,
...
export default function getLayout(
  mapLayoutToProps = defaultMapLayoutToProps,
  options: Options = {}
) {
  return (WrappedComponent: any): typeof Component => {
    ...
    const ret = hoistStatics<typeof GetLayout, typeof WrappedComponent>(
      GetLayout,
      WrappedComponent
    );
    return ret;
